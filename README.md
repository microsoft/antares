...
| CUDA >= 11.0 (x86_64) | Windows >= 10 / Ubuntu >= 20.04 | Python 3.10/3.12 | python3 -m pip install https://github.com/microsoft/antares/releases/download/v0.9.6/autort-0.9.6.3.4+cuda.zip |
