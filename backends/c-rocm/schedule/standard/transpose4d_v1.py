...
def schedule(attrs):
    ...
    s[C].bind(co, te.thread_axis('blockIdx.x'))
    s[C].bind(po, te.thread_axis('blockIdx.y'))
    s[C].bind(n, te.thread_axis('blockIdx.z'))

    s[C].bind(ct, te.thread_axis('threadIdx.x'))
    s[C].bind(pt, te.thread_axis('threadIdx.y'))

    s[C].bind(ci, te.thread_axis('vthread'))
    s[C].bind(pi, te.thread_axis('vthread'))
