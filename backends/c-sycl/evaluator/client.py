...
def eval(kernel_path, **kwargs):
    ...
    assert 0 == os.system(f'dpcpp {source_file} -I{dest_dir} -std=c++17 -lpthread -o {dest_dir}/run_graph'), "Compiling error or DPC++ SDK not found, please check the oneAPI environment."
