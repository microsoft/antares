...
custom_op = CustomOp(ir='temp0[K, N] = input0[N, K] + 100; output0[N, M] +=! temp0[K, N] * input1[K, M] where K in 10', input_orders={'input0': input0, 'input1': input1}).to(device, dtype).tune(step=100, use_cache=True, timeout=600).emit()
